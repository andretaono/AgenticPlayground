...
Mounts, possession, or multi-entity agents should extend `ActorRegistry` as the single mapping layer rather than scattering ID conversions across scenarios.
