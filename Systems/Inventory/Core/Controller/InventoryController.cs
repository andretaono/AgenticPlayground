...
namespace Game.Inventory.Core.Controller;
...
public class InventoryController : IInventory
{
    ...
    public event System.EventHandler<ItemEventArgs>? ItemAdded;
    public event System.EventHandler<ItemEventArgs>? ItemRemoved;
